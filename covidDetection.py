...
data_list_model2c = listdir('D:/covid-19 detection/covidDetection/train')
data_list_model2c

DATASET_PATH_model2c  = 'D:/covid-19 detection/covidDetection/train'
train_dir_model2c =  'D:/covid-19 detection/covidDetection/train'
test_dir_model2c =  'D:/covid-19 detection/covidDetection/test'
IMAGE_SIZE    = (150, 150)
...
TrainBatch.reset()
trainResult = model2c.evaluate(TrainBatch, steps = len(TrainBatch), use_multiprocessing = False, verbose = 1, workers=1)
...
confusion_matrix (TrainBatch.classes, Predicted_class)
plt.show()
...
confusion_matrix(TestingBatch.classes, Predicted_class)
plt.show()